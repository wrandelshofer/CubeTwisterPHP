<?php 
  ...
  require_once($_SERVER['DOCUMENT_ROOT'].'/cube/twister/scripts/tw-functions_v000-006-001.php'); // v0.6.1
  ...
  * Version:     0.6.1
  * Last Update: 04.01.2023 wr
  * 
  * Requires:    Twisty Player (cubing.net)
  * 
  * Changes:
  * - Twizzle Player Parameters: 'stickering' added: Super Cube (3x3, 4x4, 5x5, 6x6)
  * - Twizzle Player Parameters: 'stickering' added: Super Megaminx
  * - Changed 'Link TWIZZLE' into 'Link TWIZZLE Explore' and added 'Link TWIZZLE Edit'
  * 
  * To do:
  ...
  */
  ...
  /* --- Variables --- */
  $cgiFile           = "index_v000-006-001.php";  // CGI File.
  $cgiVersion        = "0.6.1 beta"; // CGI Version.
  ...
  //$url_twizzle       = "experiments.cubing.net/cubing.js/twizzle/"; // URL TWIZZLE (Twizzle Explore, cubing.net)
  $url_twizzleExpl   = "alpha.twizzle.net/explore/";                // URL TWIZZLE (Twizzle Explore, twizzle.net)
  $url_twizzleEdit   = "alpha.twizzle.net/edit/";                // URL TWIZZLE (Twizzle Edit, twizzle.net)
  ...
  if ($in['puzzle'] != "") {                                                // Wenn puzzle != "":
    ...
    $twizzleLinkExpl = "";                                                  //   leerer TWIZZLE-Explore-Link
  }
  
  /* --- Get TWIZZLE-Edit-Link --- */
  $twizzleLinkEdit = "";
  ...
  $but_show            = "Display";
  $hlp_show            = "View at Twizzle Explore";
  ...
  $txt_linkTWIZZLEexpl = "Link TWIZZLE Explore";
  $hlp_linkTWIZZLEexpl = "Link";
  
  $txt_linkTWIZZLEedit = "Link TWIZZLE Edit";
...
//  print "         anchor=\"start\" \n";                                                   // Anchor:           [start]; end.
  ...
  /* --- 01 Link TWIZZLE Explore (Textarea) --- */
  if ($in['alg'] != "") {
    $err_class = "wglIsNeutral";
    
    print "      <!-- Link TWIZZLE Explore (Textarea) BEGIN -->\n";
    print "      <div class=\"formElement formElementInput\">\n";
    print "        <!-- Label: Link TWIZZLE Explore -->\n";
    print "        <div>\n";
    print "          <label \n";
    print "            class=\"XXL ". $err_class ."\"\n";
    print "            for=\"linkTWIZZLEeplore\" \n";
    ...
    print "          <textarea \n";
    print "            class=\"XXL ". $err_class ."\" \n";
    print "            name=\"linkTWIZZLEexplore\" \n";
    print "            id=\"linkTWIZZLEexplore\" \n";
    print "            maxlength=\"\" \n";
    print "            rows=\"2\" \n";
    print "            cols=\"\" \n";
    print "            wrap=\"virtual\" \n";
    ...
    print "        </div>\n";
    print "      </div>\n";
    print "      <!-- Link TWIZZLE Explore (Textarea) END -->\n";
    print "      \n";
    print "      \n";
  }
  
  /* --- 01 Link TWIZZLE Edit (Textarea) --- */
  if ($in['alg'] != "") {
    if ($twister_puzzle_param[$in['puzzle']] != "") {
      $err_class = "wglIsNeutral";
      
      print "      <!-- Link TWIZZLE Edit (Textarea) BEGIN -->\n";
      print "      <div class=\"formElement formElementInput\">\n";
      print "        <!-- Label: Link TWIZZLE Edit -->\n";
      print "        <div>\n";
      print "          <label \n";
      print "            class=\"XXL ". $err_class ."\"\n";
      print "            for=\"linkTWIZZLEedit\" \n";
      print "            >". $txt_linkTWIZZLEedit ."<span class=\"formLabelStar\"></span></label\n";
      print "          >\n";
      print "        </div>\n";
      print "        \n";
      
      print "        <!-- Textarea: Link TWIZZLE Edit -->\n";
      print "        <div>\n";
      print "          <textarea \n";
      print "            class=\"XXL ". $err_class ."\" \n";
      print "            name=\"linkTWIZZLEedit\" \n";
      print "            id=\"linkTWIZZLEedit\" \n";
      print "            maxlength=\"\" \n";
      print "            rows=\"2\" \n";
      print "            cols=\"\" \n";
      print "            wrap=\"virtual\" \n";
      ...
      print "        </div>\n";
      print "      </div>\n";
      print "      <!-- Link TWIZZLE Edit (Textarea) END -->\n";
      print "      \n";
      print "      \n";
    }
  }
