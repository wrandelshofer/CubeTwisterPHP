<?php 
  ...
  require_once($_SERVER['DOCUMENT_ROOT'].'/cube/twister/scripts/tw-functions_v000-004-001.php'); // v0.4.1
  ...
  /* --- Variabeln --- */
  $cgiFile           = "index_v000-004-001.php"; // Name dieses CGIs.
  $cgiVersion        = "0.4.1"; // CGI Version.
