...
var PuzzleGeometry = class {
  ...
  parseBlockMove(blockmove) {
    ...
    if (loslice === 0 && hislice === this.moveplanesets[msi].length && !fullrotation) {
...
export { Orbit, OrbitDef, OrbitsDef, Perm, PuzzleGeometry, Quat, Transformation, VisibleState, getPuzzleGeometryByDesc, getPuzzleGeometryByName, getpuzzle, getpuzzles, parsedesc, schreierSims, useNewFaceNames };
