<?php 
  ...
  */
  function alg3xP_TwizzleToSse($alg) {
    ...
    $alg = preg_replace("/3D'/","<901>",$alg); $alg = preg_replace("/3D/","<902>",$alg);
    $alg = preg_replace("/3L'/","<903>",$alg); $alg = preg_replace("/3L/","<904>",$alg);
    $alg = preg_replace("/3R'/","<905>",$alg); $alg = preg_replace("/3R/","<906>",$alg);
    $alg = preg_replace("/3F'/","<907>",$alg); $alg = preg_replace("/3F/","<908>",$alg);
  ...
  */
  function alg5xD_SseToTwizzle($alg) {
    ...
    /* --- 5xD: SSE -> CODE: [6] Wide-layer twists [5] (Mid-layer twists) [4] (Verge twists) [1] Numbered layer twists --- */
    ...
    /* --- 5xD: CODE -> TWIZZLE: [4] (Verge twists) --- */
  ...
  */
  function alg5xD_TwizzleToSse($alg) {
    ...
    /* --- 5xD: OLD TWIZZLE -> CODE: [4] Verge twists --- */
    ...
    /* --- 5xD: TWIZZLE -> CODE: [4] Verge twists --- */
