<?php 
  ...
  * Version:     0.6.3
  * Last Update: 06.01.2024 wr
  * 
  * SSE to TWIZZLE:
  * - 4xPyraminx: [9] Corner twists: Incorrect translation fixed: R -> U istead of R -> R
  * - 5xPyraminx: [9] Corner twists: Incorrect translation fixed: R -> U istead of R -> R
  * 
  * TWIZZLE to SSE:
  * - Uncorrect translations fixed (Megaminx, Gigaminx):
  *   Uv' D    -> CU' D    -> CSU'   (Incorrect Second-Pass-Translation in 0.6.1!)
  *   3U' FR2  -> MU' DR2  -> MSU'R2 (Incorrect Second-Pass-Translation in 0.6.1!)
  *   3U' Uv2' -> MU' CU2' -> S2U 2' (Incorrect Second-Pass-Translation in 0.6.1!)
  * 
  * - Optimize SSE ($optSSE):
