<?php 
  ...
  /* --- Variabeln --- */
  $cgiFile           = "index_v000-001-001.php"; // Name dieses CGIs.
  $cgiVersion        = "0.1.1"; // CGI-Version.
  ...
  */
  ...
  // Check algSSE (Pflicht)
  $in{'algSSE'} = stripslashes(getPar("algSSE"));
  
  
  // Translate SSE into SiGN
  if ($in{'puzzle'} == 1) {                      // Bei 3x3 Pyraminx:
    $alg_SiGN = alg3xP_SSEToSiGN($in{'algSSE'}); //   3xP: SSE in SiGN konvertieren
  } elseif ($in{'puzzle'} == 2) {                // Bei 4x4 Master Pyraminx:
    $alg_SiGN = alg4xP_SSEToSiGN($in{'algSSE'}); //   4xP: SSE in SiGN konvertieren
  } elseif ($in{'puzzle'} == 3) {                // Bei 5x5 Professor Pyraminx:
    $alg_SiGN = alg5xP_SSEToSiGN($in{'algSSE'}); //   5xP: SSE in SiGN konvertieren
  } else {                                       // Sonst:
    $alg_SiGN = "";
  }
  
  // Get Twizzle Algorithm
  $alg_TW   = alg_SiGNtoTwizzle($alg_SiGN);    // SiGN in Twizzle konvertieren
  ...
  if ($debugmode == "true") {
    ...
    print "      algSSE: [". $in{'algSSE'} ."]<br/>\n";
    print "      SiGN: [". $alg_SiGN ."]<br/>\n";
    print "      TW: [". $alg_TW ."]<br/>\n";
    print "    </p>\n";
    print "  </div>\n";
    print "  \n";
  ...
  /* --- 01 Algorithm SSE (Textarea, Pflicht) --- */
  if ($in{'algSSE'} == "") {$err_class = "wglIsInvalid";} else {$err_class = "wglIsNeutral";}
  
  print "    <!-- Algorithm SSE (Textarea) BEGIN -->\n";
  print "    <div class=\"formElement formElementInput\">\n";
  print "      <!-- Label: Algorithm SSE -->\n";
  print "      <div>\n";
  print "        <label \n";
  print "          class=\"XXL ". $err_class ."\"\n";
  print "          for=\"algSSE\" \n";
  print "          >". $txt_algSSE ."<span class=\"formLabelStar\">*</span></label\n";
  print "        >\n";
  print "      </div>\n";
  print "      \n";
  
  print "      <!-- Textarea: Algorithm SSE -->\n";
  print "      <div>\n";
  print "        <textarea \n";
  print "          class=\"XXL ". $err_class ."\" \n";
  print "          name=\"algSSE\" \n";
  ...
  print "          cols=\"\" \n";
  print "          wrap=\"virtual\" \n";
  print "          placeholder=\"". $txt_algSSE ."\" \n";
  //print "          onChange='document.forms[\"FormA\"].submit();' \n";
  print "          >". $in{'algSSE'} ."</textarea\n";
  print "        >\n";
  print "      </div>\n";
  print "    </div>\n";
  print "    <!-- Algorithm SSE (Textarea) END -->\n";
  print "    \n";
  print "    \n";
  ...
  /* ··································································································· */
  /* --- 01 Algorithm SiGN (Textarea) --- */
  $err_class = "wglIsNeutral";
  
  print "    <!-- Algorithm SiGN (Textarea) BEGIN -->\n";
  print "    <div class=\"formElement formElementInput\">\n";
  print "      <!-- Label: Algorithm SiGN -->\n";
  print "      <div>\n";
  print "        <label \n";
  print "          class=\"XXL ". $err_class ."\"\n";
  print "          for=\"algSiGN\" \n";
  print "          >". $txt_algSiGN ."<span class=\"formLabelStar\"></span></label\n";
  print "        >\n";
  print "      </div>\n";
  print "      \n";
  
  print "      <!-- Textarea: Algorithm SiGN -->\n";
  print "      <div>\n";
  print "        <textarea \n";
  print "          class=\"XXL ". $err_class ."\" \n";
  print "          name=\"algSiGN\" \n";
  ...
  //print "          onChange='document.forms[\"FormA\"].submit();' \n";
  print "          >". $alg_SiGN."</textarea\n";
  print "        >\n";
  print "      </div>\n";
  print "    </div>\n";
  print "    <!-- Algorithm SiGN (Textarea) END -->\n";
  print "    \n";
  print "    \n";
  ...
  print "          class=\"XXL ". $err_class ."\"\n";
  print "          for=\"linkTW\" \n";
  print "          >". "Twizzel Twister Link" ."<span class=\"formLabelStar\"></span></label\n";
  print "        >\n";
  print "      </div>\n";
  print "      \n";
