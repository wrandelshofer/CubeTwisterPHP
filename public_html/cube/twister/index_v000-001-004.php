<?php 
  ...
  /* --- Variabeln --- */
  $cgiFile           = "index_v000-001-004.php"; // Name dieses CGIs.
  $cgiVersion        = "0.1.4"; // CGI Version.
  ...
  if ($in{'puzzle'} != "2xCube" && 
      ...
      $in{'puzzle'} != "5xMegaminx") {$in{'puzzle'} = "";} // Akzeptierte Werte: 2...7xCube, 3...5xPyraminx, 3...5xMegaminx.
  ...
  /* --- Button Display --- */
  if ($in{'puzzle'} != "") {
    print "        <a class=\"linkButtonNeutral\" href=\"". $twizzleLink ."\" target=\"_blank\">". $but_show ."</a>\n";
  }
