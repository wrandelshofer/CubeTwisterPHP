<?php 
  ...
  require_once($_SERVER['DOCUMENT_ROOT'].'/cube/twister/scripts/tw-functions_v000-006-003.php'); // v0.6.3
  ...
  * Version:     0.6.3
  * Last Update: 07.01.2024 wr
  * 
  * Requires:    Twisty Player (cubing.net)
  * 
  * Changes:
  * - Move count (BTM) added for TWIZZLE notation: Cube (3x3)
  * - Move count (ETM) added for TWIZZLE notation: Cube (2x2, 4x4, 5x5, 6x6, 7x7), Pyraminx (3x3), Megaminx (3x3, 5x5)
  ...
  */
  ...
  $cgiVersion        = "0.6.3 beta"; // CGI Version.
